                ...
                <div class="row pe-2">
                    ...
                    <div class="col-md-12 col-sm-12 ">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body accordion-body-id1">
                                        ...
                                        <!-- <div
                                            ...
                                            <div class="row flex-direction-center justify-content-center chooseContent" style="display:flex">
                                                <div class="col-2 d-flex justify-content-center">
                                                    <button type="button" class="btn" onclick="showImageUploader()">
                                            ...
                                            <div class="row tex-center d-flex flex-direction-center justify-content-center">
                                                <div class="col-md-3">
                                                    <input type="file" name="img_secc" id="img_secc" accept="image/*"
                                                        style="opacity:0;position:absolute;top: -1000px;">
                                                    <label for="img_secc" style="height:100%; margin:auto;display: none;"
                                                        class="form-control text-center pt-4 hover imageContent">
                                                        <div id="img-secc-preview"></div>
                                                        <div id="img-secc-label">
                                                ...
                                                <div class="col-md-7 imageContent" style="display:none">
                                                    add a description
                                                </div>
                                            </div>
                                        </div> -->
                        ...
                        <ul class="list-group list-group-horizontal-xxl my-2">
                            <button type="button" class="list-group-item text-center" onclick="addSeccion()">
...
var seccionCount = 2;
function addSeccion() {
    let accordionClassCount = ['One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight'];
    ...
    '<div class="accordion-item"> <h2 class="accordion-header" id="panelsStayOpen-heading' + ClassCount + '"> <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapse' + ClassCount +'" aria-expanded="true" aria-controls="panelsStayOpen-collapse' + ClassCount +'">' + accordionItemCount + '. Introducción </button> </h2> <div id="panelsStayOpen-collapse' + ClassCount +'" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-heading' + ClassCount +'"> <div class="accordion-body accordion-body-id' + accordionItemCount +'"> </div> <div class="row justify-content-end mbs-2"> <div class="col-md-1 d-flex justify-content-center"> <button type="button" class="btn text-center" onclick="addLeccion' + accordionItemCount +'()"> <i class="fa-solid fa-plus"></i> </button> </div> </div> </div> </div>'
}
...
function addLeccion11() {accordionItemCount2++;
let accordion = document.getElementsByClassName("accordion-body-id8"); for (let i = 0; i < accordion.length; i++) { 
        accordion[i].innerHTML += '<div class="row tex-center flex-direction-center justify-content-center border p-4 mb-3"> <div class="row flex-direction-center justify-content-center chooseContent' + accordionItemCount2 +'" style="display:flex"> <div class="col-2 d-flex justify-content-center"> <button type="button" class="btn" onclick="showImageUploader' + accordionItemCount2 +'()"> <i class="fa-solid fa-image"></i> <br> <small>Imagen</small> </button> </div> <div class="col-2 tex-center d-flex justify-content-center"> <button type="button" class="btn"> <i class="fa-solid fa-video"></i> <br> <small>Video</small> </button> </div> <div class="col-2 d-flex justify-content-center"> <button type="button" class="btn"> <i class="fa-solid fa-font"></i> <br> <small>Texto</small> </button> </div> </div> <div class="row tex-center d-flex flex-direction-center justify-content-center"> <div class="col-md-3"> <input type="file" name="img_secc' + accordionItemCount2 +'" id="img_secc' + accordionItemCount2 +'" accept="image/*" style="opacity:0;position:absolute;top: -1000px;"> <label for="img_secc' + accordionItemCount2 +'" style="height:100%; margin:auto;display: none;" class="form-control text-center pt-4 hover imageContent' + accordionItemCount2 +'"> <div id="img-secc-preview' + accordionItemCount2 +'"></div> <div id="img-secc-label' + accordionItemCount2 +'"> <img src="../Public/img/file-arrow-up-solid.svg" alt="Botón Subir Archivo"> <br> <span> Elegir Archivo<br> </span> <!-- <span class="fst-italic"> Tamaño recomendado 1280 x 720 píxeles </span> --> </div> </label> </div> <div class="col-md-7 imageContent' + accordionItemCount2 +'" style="display:none"> add a description </div> </div> </div>';
    }
}
